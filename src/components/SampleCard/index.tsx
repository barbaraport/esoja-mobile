...
export const SampleCard: React.FC<SampleCardProps> = ({ sample }) => {
  return (
    <SampleInformationContainer>
      ...
      <SampleData>
        {translate('plots.PlotCardPlants.grains')[0].toUpperCase() + translate('plots.PlotCardPlants.grains').substring(1)}: {sample?.grainsPlantA}{' '}
      </SampleData>
      <SampleData>
      ...
      <SampleData>
        {translate('plots.PlotCardPlants.grains')[0].toUpperCase() + translate('plots.PlotCardPlants.grains').substring(1)}: {sample?.grainsPlantB}{' '}
      </SampleData>
      <SampleData>
